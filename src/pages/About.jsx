...
function About() {
  return (
    <section className="flex flex-col md:flex-row justify-center items-center min-h-screen text-white px-4 md:px-24 max-w-6xl">
      <motion.img
      ...
      <div className="flex-1 text-center md:text-left">
        ...
        >
          ...
          , a B.Tech Computer Science student at the University of Petroleum and
          Energy Studies.
        </motion.p>
        <motion.p
          initial={{ opacity: 0.1, y: 100 }}
        ...
        >
          ...
          like-minded people and contributing to real-world software solutions.
        </motion.p>
      </div>
    </section>
  );
